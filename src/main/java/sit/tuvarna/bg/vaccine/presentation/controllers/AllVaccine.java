...
public class AllVaccine {
    @FXML
    public TableView<VaccineTime> vaccineList;
    @FXML
    ...
    @FXML
    public TableColumn<VaccineTime,String> ClientName;
    @FXML
    public TableColumn<VaccineTime,String> vetrinar;
    @FXML
    public TableColumn<VaccineTime,String> vaccine;
    @FXML
    ...
    private void loadDate() {
        ...
        ObservableList<VaccineTime> vaccineTimesObservableList = service.getAllTask();
       ...
       price.setCellValueFactory(p->new ReadOnlyObjectWrapper(p.getValue().getVaccine_price()));
        ...
        ClientName.setCellValueFactory(p->new ReadOnlyObjectWrapper(p.getValue().getClient().getName()));
        vetrinar.setCellValueFactory(p->new ReadOnlyObjectWrapper(p.getValue().getVeterinarian().getName()));
        vaccine.setCellValueFactory(p->new ReadOnlyObjectWrapper(p.getValue().getVaccineSet().getVaccine_name()));

        vaccineList.setItems(vaccineTimesObservableList);
